...
var ASM_CONSTS = {
  381736: () => { if (document.fullscreenElement) return 1; },  
 381782: () => { return document.getElementById('canvas').width; },  
 381834: () => { return parseInt(document.getElementById('canvas').style.width); },  
 381902: () => { document.exitFullscreen(); },  
 381929: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 382002: () => { if (document.fullscreenElement) return 1; },  
 382048: () => { return document.getElementById('canvas').width; },  
 382100: () => { return screen.width; },  
 382125: () => { document.exitFullscreen(); },  
 382152: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 382285: () => { return window.innerWidth; },  
 382311: () => { return window.innerHeight; },  
 382338: () => { if (document.fullscreenElement) return 1; },  
 382384: () => { return document.getElementById('canvas').width; },  
 382436: () => { return parseInt(document.getElementById('canvas').style.width); },  
 382504: () => { if (document.fullscreenElement) return 1; },  
 382550: () => { return document.getElementById('canvas').width; },  
 382602: () => { return screen.width; },  
 382627: () => { return window.innerWidth; },  
 382653: () => { return window.innerHeight; },  
 382680: () => { if (document.fullscreenElement) return 1; },  
 382726: () => { return document.getElementById('canvas').width; },  
 382778: () => { return screen.width; },  
 382803: () => { document.exitFullscreen(); },  
 382830: () => { if (document.fullscreenElement) return 1; },  
 382876: () => { return document.getElementById('canvas').width; },  
 382928: () => { return parseInt(document.getElementById('canvas').style.width); },  
 382996: () => { document.exitFullscreen(); },  
 383023: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 383081: () => { return screen.width; },  
 383106: () => { return screen.height; },  
 383132: () => { return window.screenX; },  
 383159: () => { return window.screenY; },  
 383186: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 383239: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 383310: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 383367: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 383623: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 383694: () => { if (document.fullscreenElement) return 1; },  
 383740: () => { return window.innerWidth; },  
 383766: () => { return window.innerHeight; },  
 383793: () => { if (document.pointerLockElement) return 1; }
};
