...
var ASM_CONSTS = {
  386952: () => { if (document.fullscreenElement) return 1; },  
 386998: () => { return document.getElementById('canvas').width; },  
 387050: () => { return parseInt(document.getElementById('canvas').style.width); },  
 387118: () => { document.exitFullscreen(); },  
 387145: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 387218: () => { if (document.fullscreenElement) return 1; },  
 387264: () => { return document.getElementById('canvas').width; },  
 387316: () => { return screen.width; },  
 387341: () => { document.exitFullscreen(); },  
 387368: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 387501: () => { return window.innerWidth; },  
 387527: () => { return window.innerHeight; },  
 387554: () => { if (document.fullscreenElement) return 1; },  
 387600: () => { return document.getElementById('canvas').width; },  
 387652: () => { return parseInt(document.getElementById('canvas').style.width); },  
 387720: () => { if (document.fullscreenElement) return 1; },  
 387766: () => { return document.getElementById('canvas').width; },  
 387818: () => { return screen.width; },  
 387843: () => { return window.innerWidth; },  
 387869: () => { return window.innerHeight; },  
 387896: () => { if (document.fullscreenElement) return 1; },  
 387942: () => { return document.getElementById('canvas').width; },  
 387994: () => { return screen.width; },  
 388019: () => { document.exitFullscreen(); },  
 388046: () => { if (document.fullscreenElement) return 1; },  
 388092: () => { return document.getElementById('canvas').width; },  
 388144: () => { return parseInt(document.getElementById('canvas').style.width); },  
 388212: () => { document.exitFullscreen(); },  
 388239: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 388297: () => { return screen.width; },  
 388322: () => { return screen.height; },  
 388348: () => { return window.screenX; },  
 388375: () => { return window.screenY; },  
 388402: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 388455: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 388526: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 388583: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 388839: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 388910: () => { if (document.fullscreenElement) return 1; },  
 388956: () => { return window.innerWidth; },  
 388982: () => { return window.innerHeight; },  
 389009: () => { if (document.pointerLockElement) return 1; }
};
